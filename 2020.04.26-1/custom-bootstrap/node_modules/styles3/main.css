...
.form-control:focus {
  ...
  border-color: #b998cd;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(125, 75, 155, 0.25);
}
...
.was-validated .custom-select:valid, .custom-select.is-valid {
  ...
  background: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='4' height='5' viewBox='0 0 4 5'%3e%3cpath fill='%23343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e") no-repeat right 0.75rem center/8px 10px, url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='8' height='8' viewBox='0 0 8 8'%3e%3cpath fill='%2306D6A0' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e") #fff no-repeat center right 1.75rem/calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);
}
...
.btn-primary:focus, .btn-primary.focus {
  ...
  background-color: #683f81;
  border-color: #613a79;
  box-shadow: 0 0 0 0.2rem rgba(145, 102, 170, 0.5);
}
...
.btn-secondary:focus, .btn-secondary.focus {
  ...
  background-color: #8d69a2;
  border-color: #87629e;
  box-shadow: 0 0 0 0.2rem rgba(173, 148, 189, 0.5);
}
...
.btn-light:focus, .btn-light.focus {
  ...
  background-color: #deb0d0;
  border-color: #daa7cb;
  box-shadow: 0 0 0 0.2rem rgba(203, 178, 197, 0.5);
}
...
.btn-accent:focus, .btn-accent.focus {
  ...
  background-color: #3f77a8;
  border-color: #3c709e;
  box-shadow: 0 0 0 0.2rem rgba(106, 156, 199, 0.5);
}
...
.btn-outline-primary:focus, .btn-outline-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(125, 75, 155, 0.5);
}
...
.btn-outline-secondary:focus, .btn-outline-secondary.focus {
  box-shadow: 0 0 0 0.2rem rgba(159, 129, 177, 0.5);
}
...
.btn-outline-light:focus, .btn-outline-light.focus {
  box-shadow: 0 0 0 0.2rem rgba(233, 203, 224, 0.5);
}
...
.btn-outline-accent:focus, .btn-outline-accent.focus {
  box-shadow: 0 0 0 0.2rem rgba(80, 138, 189, 0.5);
}
...
.custom-checkbox .custom-control-input:disabled:checked ~ .custom-control-label::before {
  background-color: rgba(125, 75, 155, 0.5);
}
...
.custom-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(125, 75, 155, 0.25);
}
...
button.bg-primary:focus {
  background-color: #613a79 !important;
}

.bg-secondary {
  background-color: #9F81B1 !important;
}

a.bg-secondary:hover, a.bg-secondary:focus,
button.bg-secondary:hover,
button.bg-secondary:focus {
  background-color: #87629e !important;
}
...
.bg-light {
  background-color: #E9CBE0 !important;
}

a.bg-light:hover, a.bg-light:focus,
button.bg-light:hover,
button.bg-light:focus {
  background-color: #daa7cb !important;
}
...
.bg-accent {
  background-color: #508abd !important;
}
...
.text-primary {
  color: #7D4B9B !important;
}

a.text-primary:hover, a.text-primary:focus {
  color: #533267 !important;
}

.text-secondary {
  color: #9F81B1 !important;
}
...
.text-light {
  color: #E9CBE0 !important;
}

a.text-light:hover, a.text-light:focus {
  color: #d295c0 !important;
}
...
.text-accent {
  color: #508abd !important;
}

a.text-accent:hover, a.text-accent:focus {
  color: #35638c !important;
}
